...
- [x] **Agent.6** Loop-Optimized Task Template — Create `.agent/task-template.md` optimized for long-running agentic sessions with explicit browser recording slots.
