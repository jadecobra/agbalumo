...
func main() {
	...
	products := []domain.Listing{
		...
		{Title: "Nigerian Ankara Fabrics", OwnerOrigin: "Nigeria", Type: domain.Product, Anchor: "Fashion", Description: "Colorful Ankara prints by the yard.", City: "Houston", Address: "2202 Westheimer Rd, Houston, TX 77006", ContactEmail: "ankara@naija.com"}, // Houston for variety? Sticking to DFW per request mostly. Let's start DFW.
		// Correction: User asked for DFW.
...
func seedGroup(ctx context.Context, repo *sqlite.SQLiteRepository, name string, listings []domain.Listing) {
	log.Printf("\nSeeding %s...", name)
