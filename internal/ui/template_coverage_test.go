...
var TemplateMockRegistry = map[string]interface{}{
	...
	"sandbox.html": common.SandboxViewModel{
		...
		// Note: pruned admin/metrics/toast/pagination/extra-listing mocks (and associated test data) as part of matrix scope trim + handler mock pruning (checkpoint §5). Retained only fields present in current SandboxViewModel.
