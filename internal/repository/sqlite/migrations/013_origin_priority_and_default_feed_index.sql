...
-- STATEMENT
CREATE INDEX IF NOT EXISTS idx_listings_default_feed ON listings(is_active, status, featured DESC, origin_priority ASC, heat_level DESC, rating DESC, created_at DESC);
