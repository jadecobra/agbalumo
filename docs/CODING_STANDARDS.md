...
*   **Coverage Threshold**: Enforced value lives in `.agent/coverage-threshold`. NEVER lower this value, even to bypass failing tests. If coverage drops, you MUST write more tests. Lowering the threshold is strictly forbidden.
