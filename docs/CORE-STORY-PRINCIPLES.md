...
This document captures the agreed core narrative for Agbalumo, the voice rules, transparency requirements, and guiding principles. Future sessions must reference this file before writing any public-facing copy or making changes to how the story appears on the site.

## The Story (Final Approved Version)

We built Agbalumo for the times we land in a new city and want food that feels like home, or the African-owned places where we don’t have to explain ourselves. We are creating the network where businesses owned by people like us are seen by people like us, who value them most, and where we can quickly find what we need and plug into the community no matter where we are. Right now the strongest part of this network is Nigerian and West African food in Dallas and a few cities in the Northeast. This is where we started.

This is the version approved for WhatsApp groups, social media, and all outreach. It is warm, visionary, and honest.

## Voice Rule (Non-Negotiable)

- All public-facing story and narrative copy must use **"we" voice** exclusively.
- This reads as a collective internal monologue — the shared voice of the community and the people building this.
- Never use "you" when speaking about the user, the diaspora, or potential visitors in the story itself.
- The tone should feel like we are talking among ourselves about something that matters to us, not like a product talking at an audience.

This rule applies to the About page, any introductory microcopy on the home, supporting text near "Post", outreach copy, and any future narrative elements.
...
- This is the beginning of the network, not the finished version.
...
Narrative changes must never degrade the speed or cleanliness of the core discovery experience.

## How the Story Lives on the Site

- **Primary carrier**: The About page carries the full story, the vision, and the explicit "Where we are right now" transparency statement.
- **Home experience**: Light, skimmable microcopy that sets expectations without competing with the functional tools (Near Me, listings grid, Featured).
- **Participation**: "Post" remains the action label. Supporting microcopy frames it as contributing to the network.
...
4. Keep changes minimal and respectful of the functional experience.

This file is the contract for how we talk about what we are building.